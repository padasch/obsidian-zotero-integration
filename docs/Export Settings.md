...
The output path is where the exported markdown should be saved within your vault. Output paths support templating. You can view the data available to templates using the `Test import template with Zotero item` command in Obsidian's command palette.
